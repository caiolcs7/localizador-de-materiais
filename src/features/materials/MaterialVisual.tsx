...
function screw(family: MaterialVisualFamily, fill: string) {
  ...
  return <g>
    ...
    {hex ? <path d="M22 55l14-10h25l13 10v40L61 105H36L22 95Z" fill={fill} className="material-outline"/> :
      ...
      socket && !button ? <path d="M24 44h40v52H24Z" rx="5" fill={fill} className="material-outline"/> :
...
function rivnut(closed: boolean, fill: string) {
  return <g>
    ...
    <path d="M59 44v34M68 44v34M77 44v34M86 44v34M95 44v34" className="material-knurl"/>
...
function visualFor(family: MaterialVisualFamily, finish: MaterialFinish, fill: string, metalId: string, maskId: string): ReactNode {
  ...
  if (family === 'rivnut-open' || family === 'rivnut-closed') return rivnut(family === 'rivnut-closed', fill)
