...
import { Archive, Camera, Database, Download, FileDown, Menu, Moon, PackagePlus, Search, Star, Sun, Upload, X } from 'lucide-react'
...
export default function App() {
  ...
  const [scanner,setScanner]=useState(false); const [editor,setEditor]=useState<Partial<InventoryLocation>|null>(null); const [showItems,setShowItems]=useState(false); const [showData,setShowData]=useState(false); const [mobileMenu,setMobileMenu]=useState(false)
