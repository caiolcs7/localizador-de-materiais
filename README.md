...
- `/`: consulta e cadastro público de novas localizações, sem permissão para editar ou excluir.
- `/admin`: login obrigatório para editar/excluir materiais e administrar carrinhos, backups e acessos.
...
Os testes cobrem busca exata, múltiplas localizações, equivalência AI4/AI6, case-insensitive, bloqueio de BC↔AI4, histórico de consultas sem fragmentos/duplicatas, formulário administrativo, fórmula da calculadora, leitura decimal e persistência do histórico local.
...
- Toda tabela exposta tem RLS: materiais e carrinhos têm leitura pública; visitantes podem apenas inserir novas localizações, enquanto edição e exclusão exigem administrador ativo.
